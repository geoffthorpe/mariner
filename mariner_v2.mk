...
define make_mariner_terminator
	...
	$(file >$(mmtPathEnv),# Auto-generated by Mariner)
	...
	$(eval mmtY6 := $$Qecho "COPY environment /etc" >> $(mmtPath)/Dockerfile)
	$(eval mmtY := mmtY1 mmtY2 mmtY3 mmtY4 mmtY5 mmtY6 mmtY7)
	$(if $(mmtCAp),
		$(eval mmtY8 := $$Qecho "RUN apt-get install -y ca-certificates" >> $(mmtPath)/Dockerfile)
		$(eval mmtY9 := $$Qecho "RUN mkdir -p $(mmtImgCA)" >> $(mmtPath)/Dockerfile)
		$(eval mmtY10 := $$Qfor i in `cd $(mmtPathCA) && ls`; do \)
		$(eval mmtY11 := echo "ADD CA-certs/$$$$$$$$i $(mmtImgCA)" >> $(mmtPath)/Dockerfile; \)
		$(eval mmtY12 := echo "RUN echo 'Mariner-injection/$$$$$$$$i' >> $(mmtEtcCA)" >> $(mmtPath)/Dockerfile; \)
		$(eval mmtY13 := done)
		$(eval mmtY14 := $$Qecho "RUN update-ca-certificates" >> $(mmtPath)/Dockerfile)
		$(eval mmtY += mmtY8 mmtY9 mmtY10 mmtY11 mmtY12 mmtY13 mmtY14)
	)

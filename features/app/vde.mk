# Clones VDE if it hasn't been cloned, updates it, compiles it, and installs it.
#
# The git clone is made in $(HOME), so it shows up in $(HOME)/vde-2. If
# persistence is desired, mount something at that path.
#
# As with all user-space-building recipes in Mariner, VDE2 is configured with
# an install prefix of /install. Mounting something at that path would likely
# make sense.

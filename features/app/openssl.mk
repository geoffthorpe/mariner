# Clones openssl if it hasn't been cloned, updates it, compiles it, and
# installs it.
#
# The git clone is made in $(HOME), so it shows up in $(HOME)/openssl. If
...
define $($F_FN)
	...
	$(eval $(FPARAM_NEW_IMAGE)_build_COMMAND := sudo --login -u $(shell whoami) /openssl.sh)
